  ...
  if (host != null) {
    for (const childNode of Array.from(parentElm.childNodes)) {
      if (childNode["s-sh"] != null) {
        ...
        if (childNode.nodeType === 1 && !!childNode["s-sn"]) {
...
render() {
        ...
        if (slotRefNode) {
          ...
          if (!insertBeforeNode && parentNodeRef !== nodeToRelocate.parentNode || nodeToRelocate.nextSibling !== insertBeforeNode) {
            if (nodeToRelocate !== insertBeforeNode) {
              ...
              if (BUILD.experimentalSlotFixes && nodeToRelocate.nodeType === 1 && slotRefNode["s-fs"] !== nodeToRelocate.getAttribute("slot")) {
                if (!slotRefNode["s-fs"]) {
  ...
  if (BUILD.experimentalSlotFixes && cmpMeta.$flags$ & 2) {
    ...
    if (BUILD.style && Cstr.style) {
      ...
      if (!styles.has(scopeId2)) {
        ...
        BUILD.shadowDomShim && cmpMeta.$flags$ & 8) {
          style = await import("./shadow-css-BOH2LV4Q.js").then((m) => m.scopeCss(style, scopeId2, false));
        }
...
var proxyCustomElement = (Cstr, compactMeta) => {
  ...
  if (BUILD.experimentalSlotFixes && BUILD.scoped && cmpMeta.$flags$ & 2) {
...
*/
//# sourceMappingURL=chunk-4ZQ6RTTO.js.map
